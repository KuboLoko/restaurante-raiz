  ...
  return (
    <section id="top" className="relative flex min-h-[100svh] items-center overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <img
          src="/img/hero.jpg"
          alt="Prato de lingueirão grelhado servido no RAIZ, iluminado sobre mesa escura"
      ...
      <div className="container-raiz w-full py-28 sm:py-32">
        <div className="max-w-2xl animate-fade-up">
          <p className="eyebrow-light">
            ...
            Barreiro · Cozinha portuguesa contemporânea
          </p>
          ...
          <div className="mt-10 flex items-center gap-3 text-sm text-raiz-cream/75">
            ...
            <span>
              <strong className="font-semibold text-raiz-cream">{site.rating.value.toString().replace('.', ',')}</strong>{' '}
